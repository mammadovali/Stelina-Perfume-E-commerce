#pragma checksum "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b7a98d958d99f6f3a64a413e5e42cc33a1d47213"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b7a98d958d99f6f3a64a413e5e42cc33a1d47213", @"/Views/Shared/_BasketScriptsPartial.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b7a98d958d99f6f3a64a413e5e42cc33a1d472136011", async() => {
            }
            );
...
");
            WriteLiteral(@"                             }else{
                             ...
                             if(res.value == null){
                                 ...
                                 $("".actions-baske");
            WriteLiteral(@"t"").append(noProductDiv);
    ...
    function changeQuantity(event, element){
        ...
        $.processId = setTimeout(function(){
           ");
            WriteLiteral(" const elementData = $(element).data();\r\n            elementData.Quantity = element.value;\r\n            $.ajax({\r\n                     url: `");
#nullable restore
#line 91 "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable disable
    ...
    function addToBasket(e){
        ...
        $.ajax({
            url: `");
#nullable restore
#line 129 "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable disable
            ...
            success: function(res){
                ...
                if(res.error == false){
                    ...
                    ");
            WriteLiteral(@"    $('.total-price').add("".Price-amount"").text(`${res.value.basketInfo.total}₼`);
                    }
 ...
 ");
    ...
    $(document).ready(function(){
     ...
     ");
            WriteLiteral("          var searchTerm = e.currentTarget.value\r\n\r\n               var obj = {\"searchTerm\" : searchTerm}\r\n               \r\n               //console.log(obj)\r\n\r\n               $.ajax({\r\n                  url: \'");
#nullable restore
#line 245 "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml"
