#pragma checksum "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "51eed4b839a8262a46ab13830e0659c53f2d3cef"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"51eed4b839a8262a46ab13830e0659c53f2d3cef", @"/Views/Shared/_BasketScriptsPartial.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "51eed4b839a8262a46ab13830e0659c53f2d3cef5748", async() => {
            }
            );
...
#nullable disable
    ...
    function addToBasket(e){
        ...
        $.ajax({
            url: `");
#nullable restore
#line 125 "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable restore
#line 242 "C:\Users\Əli\Desktop\Stelina e-commerce\Stelina Solution\Stelina-Perfume-E-commerce\Stelina.WebUI\Views\Shared\_BasketScriptsPartial.cshtml"
...
#nullable disable
            WriteLiteral(@"',
                  ...
                  contentType: 'application/x-www-form-urlencoded',
                  beforeSend: function(){
                      $(""ul.search-results"").css(""display"", ""block"");
                      $(""ul.earch-results"").html(""<div>Loading...</div>"");
                  },
                  success: function(res){
                      setTimeout(function(){
                          console.log(res)
                          ...
                          //var spanValue = $html.find("".search-info .title"").text();

                          $(""ul.search-results"").html(res).css(""display"", ""block"");

                           if($("".input-search"").val = ''){
                               console.log(""bosh input"")
                               $(""ul.search-results"").css(""display"", ""none"");
                               return;
                           }

       ");
            WriteLiteral(@"                   if($(""ul.search-results"").children().length == 0){
